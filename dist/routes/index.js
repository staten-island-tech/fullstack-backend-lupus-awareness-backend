...
router.get('/comments/:id', requiresAuth, comments_1.populateComments);
router.get('/interested', userInterested_1.allInterested);
router.get('/interested/:id', requiresAuth, userInterested_1.populateUser);
...
router.post('/user/:id', requiresAuth, userMiddleware_1.subscribe);
